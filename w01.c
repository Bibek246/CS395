...
// Program Name: Minimum Distance Finder
// Description: This program determines the minimum distance between
// any two elements in an array provided as command line arguments.
